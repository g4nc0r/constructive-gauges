...
\item \textbf{Minimal completeness} (Theorem~\ref{thm:mincomplete}, \S\ref{sec:mincomplete}): the full subset of $\{c, f, \mathbf{1}\}$ is the unique product-form member closing all three parasitic pathways; the result is structural and requires no price model or population assumption.
